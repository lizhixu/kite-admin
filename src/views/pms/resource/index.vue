...
<template>
  <CommonPage>
    <div class="h-full flex gap-x-12">
      <div class="cus-scroll h-full w-320 shrink-0 overflow-y-auto pr-12">
      ...
      <div ref="contentRef" class="cus-scroll h-full w-0 flex-1 overflow-y-auto pl-12 pr-12">
